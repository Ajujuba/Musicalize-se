...
<div class="container">
    <div class="row">
         <br>
          <center><h3>Escolha um curso para criar a classe</h3></center>
          <br>
          <div class="col-md-4">
          <br>
                    ...
                    <table class="table">
                         ...
                         <tbody>
                              <?php foreach ($listaCurso as $linha): ?>
                                   ...
                                   <td><a href="classe-Adm-inserir.php?id=<?php echo $linha['idcurso']?>" class="btn btn-info">Criar classe</a></td>
                                   </tr>
                              <?php endforeach ?>
                         </tbody>
                    </table>
