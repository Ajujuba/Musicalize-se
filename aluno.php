...
<body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
          ...
          <div class="container">
               ...
               <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-nav-first">
                         ...
                         <li><a href="#team" class="smoothScroll">Avisos</a></li>
                         <li><a href="curso.php" class="smoothScroll">Cursos</a></li>
                         <li><a href="#testimonial" class="smoothScroll">Professores</a></li>
    ...
    <div class="row">
          <div class="col-md-4">
               <button type="button" class="form-control" data-toggle="modal" data-target="#logina">
                    Inserir Aluno
               </button>
               <!-- Modal -->
               <div class="modal fade" id="logina" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                         <div class="modal-content">
                         <div class="modal-header">
                              <h5 class="modal-title" id="exampleModalLabel">Área de Login do Administrador</h5>
                         ...
                         <div class="modal-footer">
                              ...
                              <form action="homeAdm.php"><button type="submit" class="btn btn-info">Entrar</button></form>
                         </div>
                    </div>
               </div>
          </div>
