...
<body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
    ...
    <div class="row">
        <div class="col-md">
            <br>
            <form action="contato-editar-post.php" method="POST">
                <input type="hidden" name="idcontato" value="<?php echo $contato->idcontato ?>">
                    <div>
                        <input type="radio" id="status" name="status" value="">
                        <label for="dewey">Marcar que o contato já foi respondido via email</label>
                        <br><small>*Marcando essa opção a mensagem será removida da lista de Contatos para evitar incomodos* </small>
                    </div>
                        <div class="modal-footer">
                            <a href="contato.php" class="btn btn-secondary" >Voltar</a>
