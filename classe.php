...
<body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
    ...
    <section class="navbar custom-navbar navbar-fixed-top" role="navigation">
          ...
          <div class="container">
               <div class="row">
               <br>
               <center><h3>Lista de Classes</h3></center>
               <br>
                    <div class="col-md-12">
                    <br><br>
                         <table class="table">
                              <thead>
                                   <tr>
                                        ...
                                        <th>Curso</th>
                                        <th>Periodo</th>
                                        <th class="acao">Lista de alunos</th>
                                   </tr>
                              </thead>
                              <tbody>
                                   <?php foreach ($lista as $linha): ?>
                                        ...
                                        <td><a href="alunoclasse.php?id=<?php echo $linha['idclasse'] ?>" target="blank" class="btn btn-info">Abrir</a></td>
                                        </tr>
                                   <?php endforeach ?>
                              </tbody>
                         </table>
