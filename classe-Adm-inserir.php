...
<?php
    ...
    $id = $_GET['id'];
     ...
     try {
         ...
         $lista = Professor::listarProfessor_curso($id);
     } catch(Exception $e) {
         Erro::trataErro($e);
     }
...
<body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
    ...
    <div class="row">
        <br>
        <center><h3>Cadastro de classe</h3></center>
        <br>
        <br>
                            <form action="classe-adn-inserir-post.php" method="POST">
                                   
                                   <div class="form-group">
                                        <label for="email">Selecione o professor</label>
                                        <select name="professor_idprofessor" id="professor_idprofessor">
                                             <?php foreach ($lista as $linha): ?>
                                             <option value="<?php echo $linha['idprofessor'] ?>"><?php echo $linha['professor_nome'] ?></option>
                                             <?php endforeach ?>
                                        </select>
                                   </div>
                                   ...
                                   <div class="form-group">
                                        <label for="telefone">Periodo</label>
                                        <input type="text" class="form-control" id="periodo" name="periodo" placeholder="Digite o periodo da classe"  required>
                                   </div>

            
                                   <div class="modal-footer">
                                        <a href="classe-adm-curso.php" class="btn btn-secondary" >Voltar</a>
