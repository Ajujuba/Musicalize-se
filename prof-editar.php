...
<body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md">
                <form action="prof-editar-post.php" method="POST">
                <input type="hidden" name="idprofessor" value="<?php echo $professor->idprofessor ?>">
                    <div class="form-group">
                        <label for="nome">Nome</label>
                        <input type="text" class="form-control" id="nome"  name="nome" value="<?php echo $professor->nome ?>" aria-describedby="emailHelp" placeholder="Nome do professor"  required>
                    </div>
                    <div class="form-group">
                        <label for="email">Endereço de email</label>
                        <input type="email" class="form-control" id="email" name="email" value="<?php echo $professor->email ?>" aria-describedby="emailHelp" placeholder="Email do professor" required>
                    </div>
                    <div class="form-group">
                        <label for="telefone">RG</label>
                        <input type="text" class="form-control"  id="rg" name="rg" value="<?php echo $professor->rg ?>" placeholder="RG do professor"  required>
                    </div>
                    <div class="form-group">
                        <label for="telefone">CPF</label>
                        <input type="text" class="form-control"  id="cpf" name="cpf" value="<?php echo $professor->cpf ?>" placeholder="CPF do professor"  required>
                    </div>
                    <div class="form-group">
