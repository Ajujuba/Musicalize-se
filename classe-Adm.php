...
<div class="container">
    <div class="row">
         <br>
          <center><h3>Gerenciador de classes</h3></center>
          <br>
          <div class="col-md-4">
          <br>

               <form id="contact-form">
                    <a href=classe-adm-curso.php>
                    <button type="button" name="inserir_curso" class="form-control">
                            Criar nova classe
                    </button>
                    </a>
               </form>
                    ...
                    <table class="table">
                         <thead>
                              <tr>
                                   ...
                                   <th>Curso</th>
                                   <th>Periodo</th>
                                   <th>Desativar classe<th>
                                   <!-- <th class="acao">Editar</th>
                                   <th class="acao">Excluir</th> -->
                              </tr>
                         </thead>
                         <tbody>
                              <?php foreach ($listaClasse as $linha): ?>
                                   <tr>
